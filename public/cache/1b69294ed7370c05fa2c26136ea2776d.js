!function($){$(function(){var $win=$(window),$nav=$('.subnav'),navHeight=$('.navbar').first().height(),navTop=$('.subnav').length&&$('.subnav').offset().top-navHeight,isFixed=0
processScroll()
...
$nav.removeClass('subnav-fixed')}}})}(window.jQuery)
